...
/**
 * Core logic for fetching menu information.
 * <br>
 * Performs an get request to {@link #url}, and then parses menu & pricing information from that.
 * <br>
 * Doubles as a main class for testing & debugging
 */
public class MainMensaScraper {

    //private static final String url = "http://universitaet-basel.sv-restaurant.ch/de/menuplan/";
    private static final String url = "https://biozentrum-neubau.sv-restaurant.ch/de/menuplan/";
